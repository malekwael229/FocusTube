...
- Added deterministic catalog and localization contract checks, native Chromium Arabic and unsupported-locale fallback text/metadata coverage, and package checks for all eight supported catalogs. These checks do not establish complete live-site, native-speaker, or native Firefox localization coverage.

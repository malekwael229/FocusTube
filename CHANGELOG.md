...
- Added deterministic catalog and localization contract checks, native Chromium Arabic and unsupported-locale fallback text/metadata coverage, and package checks for all eight 160-key catalogs. Manual, live-site, native-speaker, native Firefox localization, and the post-repair aggregate gate remain pending.
